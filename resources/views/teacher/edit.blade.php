    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <form action="http://localhost:8000/teacher/{{$teacher->id}}" method="post" class="form-group">
            	...
            	<input type="text" name="desi" placeholder="" class="form-control" value="{{$teacher->desi}}">
            	<label>District</label>
            	<input type="text" name="district" placeholder="" class="form-control" value="{{$teacher->district}}"><br>
            	<button type="submit" name="submit" class="form-control btn bg-success">Update</button>
            	 {{csrf_field()}}
            </form>
